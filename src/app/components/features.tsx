    ...
    <>
      <div className=" mx-auto w-11/12 mt-20  ">
        <div className="flex flex-col gap-2.5 ,d:w-1/3 w-full">
          <h1 className={`${montserrat.className} font-bold text-3xl`}>
            Collaborate and Build with DevCollab
          </h1>
          <p className={`${didact_gothic.className} font-bold text-lg `}>
            Make your projects more organized and track progress on all your
            projects with your team.
          </p>
        </div>
        <div className="flex flex-col md:flex-row itmes-center justify-between gap-5 md:gap-10 md:w-11/12  w-full mx-auto mt-9 ">
          <div className="h-fit py-4  flex-1 aspect-square px-5 bg-gray-50 flex flex-col gap-7">
            <Image
