...
export default function TaskPopup() {
  return (
    <div className="absolute top-1/4 left-1/2  transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-xl p-5 rounded-sm h-fit flex flex-col justify-center  w-[300px] gap-5 border">
